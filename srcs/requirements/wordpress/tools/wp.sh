...
if ! wp core is-installed --path=/var/www/html --allow-root; then
	...
	wp plugin install "Redis Object Cache" --activate --url=${WORDPRESS_SITE_URL} --path=/var/www/html --allow-root
	wp plugin activate "redis-object-cache" --url=${WORDPRESS_SITE_URL} --path=/var/www/html --allow-root
fi
php-fpm8.1 -F